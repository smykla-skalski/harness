...
mod tests {
    ...
    fn find_agent_by_runtime<'a>(state: &'a SessionState, runtime: &str) -> &'a AgentRegistration {
        state
            .agents
            .values()
