...
/// Resolve the repo root for create validation.
///
...
pub fn create_validation_repo_root(
    ...
    Err(CliErrorKind::missing_file("unable to locate repo root for create validation").into())
}

/// Validate suite create paths.
///
...
pub fn validate_suite_create_paths(
    paths: &[&Path],
    _repo_root: &Path,
    _allow_skip: bool,
