...
impl crate::agents::acp::supervision::WatchdogEventEmitter for RecordingTurnEmitter {
    fn emit_state(
        &self,
        _from: crate::agents::acp::supervision::WatchdogState,
        _to: crate::agents::acp::supervision::WatchdogState,
        _reason: Option<&str>,
    ) {
    }
