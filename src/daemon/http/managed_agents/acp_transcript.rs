...
#[utoipa::path(
    ...
    tag = "managed-agents",
    description = "Read the recorded ACP agent transcript entries for a session. The session_id query parameter is required; omitting it returns a 400 usage error",
    params(
