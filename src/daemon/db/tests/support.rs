use super::*;
    ...
    pub(super) fn sample_worktree_project(repository_root: &str, worktree_root: &str) -> DiscoveredProject {
    ...
    pub(super) fn performance_session_state(project_index: usize, session_index: usize) -> SessionState {
        use crate::agents::runtime::RuntimeCapabilities;
        use crate::session::types::{
            AgentRegistration, AgentStatus, SessionMetrics, SessionRole, TaskQueuePolicy,
            TaskSeverity, TaskSource, TaskStatus,
