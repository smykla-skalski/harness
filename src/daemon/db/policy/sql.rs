...
pub(super) const SELECT_WORKSPACE: &str =
    "SELECT active_canvas_id, workspace_schema_version, review_text_paste_dry_run_canvas_deleted \
    FROM policy_workspace WHERE singleton = 1";
pub(super) const SELECT_CANVASES: &str =
    "SELECT canvas_id, position, title, is_review_text_paste_dry_run_canvas, \
