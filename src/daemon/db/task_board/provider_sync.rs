...
/// Releases the scope row this attempt held: dropped if the attempt created
/// it, or marked healthy again if it only leased an existing one.
async fn release_provider_scope_row_in_tx(
