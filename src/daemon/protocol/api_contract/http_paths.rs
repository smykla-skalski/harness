...
pub const TASK_BOARD_POLICY_CANVASES_DUPLICATE: &str = "/v1/task-board/policy/canvases/duplicate";
...
pub const TASK_BOARD_POLICY_SCENARIOS_CREATE: &str = "/v1/task-board/policy/scenarios/create";
pub const TASK_BOARD_POLICY_SCENARIOS_UPDATE: &str = "/v1/task-board/policy/scenarios/update";
pub const TASK_BOARD_POLICY_SCENARIOS_DELETE: &str = "/v1/task-board/policy/scenarios/delete";
pub const TASK_BOARD_POLICY_SCENARIOS_RESET: &str = "/v1/task-board/policy/scenarios/reset";
