...
pub const DEPENDENCY_UPDATES_CAPABILITIES: &str = "/v1/dependency-updates/capabilities";
pub const DEPENDENCY_UPDATES_QUERY: &str = "/v1/dependency-updates/query";
pub const DEPENDENCY_UPDATES_ACTION_PREVIEW: &str = "/v1/dependency-updates/action-preview";
...
pub const DEPENDENCY_UPDATES_RERUN_CHECKS: &str = "/v1/dependency-updates/rerun-checks";
...
pub const DEPENDENCY_UPDATES_REVIEW_THREADS_RESOLVE: &str =
    "/v1/dependency-updates/review-threads/resolve";
