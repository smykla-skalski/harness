...
pub const MANAGED_AGENT_START_OPENROUTER: &str = "managed_agent.start_openrouter";
pub const MANAGED_AGENT_PROMPT_OPENROUTER: &str = "managed_agent.prompt_openrouter";
