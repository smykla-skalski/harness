...
- **M3 — Review loop always closes.** Submit-for-review → reviewers → consensus or bounded-round leader arbitration → task reaches Done. No stalls. *Check: review terminates within the round cap, every time, including the dispute path.*
