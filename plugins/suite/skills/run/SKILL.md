...
hooks:
  - hooks:
    - command: harness hook --agent copilot suite:run verify-bash
      type: command
    - command: harness hook --agent copilot suite:run audit
      type: command
    matcher: Bash
  - hooks:
    - command: harness hook --agent copilot suite:run verify-question
      type: command
    - command: harness hook --agent copilot suite:run audit
      type: command
    matcher: AskUserQuestion
  - hooks:
    - command: harness hook --agent copilot suite:run verify-write
      type: command
    - command: harness hook --agent copilot suite:run audit
      type: command
    matcher: Write
  ...
  PostToolUseFailure:
  - hooks:
    - command: harness hook --agent copilot suite:run enrich-failure
      type: command
    - command: harness hook --agent copilot suite:run audit
      type: command
    matcher: Bash
  PreToolUse:
  - hooks:
    - command: harness hook --agent copilot suite:run guard-bash
      type: command
    matcher: Bash
  - hooks:
    - command: harness hook --agent copilot suite:run guard-question
      type: command
    matcher: AskUserQuestion
  - hooks:
    - command: harness hook --agent copilot suite:run guard-write
      type: command
    matcher: Write
  - hooks:
    - command: harness hook --agent copilot suite:run guard-write
  ...
  Stop:
  - hooks:
    - command: harness hook --agent copilot suite:run guard-stop
      type: command
  SubagentStart:
  - hooks:
    - command: harness hook --agent copilot suite:run context-agent
      type: command
    matcher: preflight-worker
  SubagentStop:
  - hooks:
    - command: harness hook --agent copilot suite:run validate-agent
      type: command
    matcher: preflight-worker
---
...
Repo-local skill package. Hooks run through `harness hook --agent copilot suite:run <hook-name>`. `SessionStart` hooks install a repo-aware `harness` wrapper on `PATH`. Run `harness --help` for all subcommands.
