...
enum PolicyCanvasGraphQualityBudgets {
  ...
  static let bySampleID: [String: [PolicyCanvasQualityCategory: Int]] = [
    ...
    "extreme-mesh": [
      ...
      .wrongTurns: 161, .labelOverlaps: 45, .labelOnBody: 2,
    ],
    "extreme-lattice": [
      ...
      .wrongTurns: 246, .labelOverlaps: 92, .labelOnBody: 4,
    ],
    "extreme-galaxy": [
      ...
      .wrongTurns: 381, .labelOverlaps: 132, .labelOnBody: 10,
    ],
  ]
}
