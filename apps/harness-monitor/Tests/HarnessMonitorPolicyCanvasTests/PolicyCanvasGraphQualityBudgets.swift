...
enum PolicyCanvasGraphQualityBudgets {
  ...
  static let bySampleID: [String: [PolicyCanvasQualityCategory: Int]] = [
    ...
    "extreme": [
      ...
      .crossingsIndependent: 10, .longEdges: 6, .labelOverlaps: 3,
    ],
    "extreme-braid": [
      .portOverlaps: 9, .portDetached: 12, .corridorReuse: 175, .corridorParallel: 113,
      .crossingsIndependent: 362, .longEdges: 63, .labelOverlaps: 13,
    ],
    "extreme-matrix": [
      .portOverlaps: 14, .portDetached: 16, .corridorReuse: 207, .corridorParallel: 204,
      .crossingsIndependent: 543, .longEdges: 89, .labelOverlaps: 21, .labelOnBody: 5,
    ],
    "extreme-mesh": [
      .portOverlaps: 18, .portDetached: 25, .corridorReuse: 424, .corridorParallel: 347,
      .crossingsIndependent: 1215, .longEdges: 142, .labelOverlaps: 45, .labelOnBody: 2,
    ],
    "extreme-lattice": [
      .portOverlaps: 31, .portDetached: 40, .corridorReuse: 1036, .corridorParallel: 1297,
      .crossingsIndependent: 3552, .longEdges: 263, .labelOverlaps: 92, .labelOnBody: 4,
    ],
    "extreme-galaxy": [
      .portOverlaps: 51, .portDetached: 66, .corridorReuse: 2335, .corridorParallel: 2051,
      .crossingsIndependent: 8808, .longEdges: 422, .labelOverlaps: 132, .labelOnBody: 10,
    ],
  ]
}
