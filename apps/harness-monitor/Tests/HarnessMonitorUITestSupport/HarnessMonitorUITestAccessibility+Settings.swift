extension HarnessMonitorUITestAccessibility {
  ...
  static let settingsMobileSection = "harness.settings.section.mobile"
  ...
  static let settingsReviewsOrganizationsField = "harness.settings.reviews.organizations"
  static let settingsReviewsRepositoriesField = "harness.settings.reviews.repositories"
  ...
  static let settingsReviewsPullRequestNumberToggle =
    "harness.settings.reviews.show-row-pr-number"
  static let settingsReviewsPullRequestAgeToggle =
  ...
  static let settingsPoliciesMinimapCenteringPicker =
  ...
  static let settingsSecretsReloadButton = "harness.settings.secrets.reload"
  static let settingsSecretsSaveButton = "harness.settings.secrets.save"
  ...
  static func settingsTBInboxRepoRow(_ index: Int) -> String {
    "harness.settings.task-board.github-inbox.repositories.\(index).row"
  }

  static func settingsTBInboxRepoRemoveButton(_ index: Int) -> String {
    "harness.settings.task-board.github-inbox.repositories.\(index).remove"
  }

  static func settingsTBInboxLabelRow(_ index: Int) -> String {
    "harness.settings.task-board.github-inbox.label-filter.\(index).row"
  }

  static func settingsTBInboxLabelRemoveButton(_ index: Int) -> String {
