enum HarnessMonitorUITestAccessibility {
  ...
  static let dashboardAgentsRoot = "harness.dashboard.agents"
  static let dashboardAgentDetail = "harness.dashboard.agents.detail"
  static let dashboardTerminalCreateButton = "harness.dashboard.agents.terminal.create"
  static let dashboardTerminalCreateSheet = "harness.dashboard.agents.terminal.create.sheet"
  static let dashboardTerminalWorkspacePicker =
    "harness.dashboard.agents.terminal.create.workspace"
  static let dashboardTerminalRuntimePicker = "harness.dashboard.agents.terminal.create.runtime"
  static let dashboardTerminalNameField = "harness.dashboard.agents.terminal.create.name"
  static let dashboardTerminalPromptField = "harness.dashboard.agents.terminal.create.prompt"
  static let dashboardTerminalStartButton = "harness.dashboard.agents.terminal.create.start"
  static let dashboardTerminalInputField = "harness.dashboard.agents.terminal.input"
  static let dashboardTerminalSendButton = "harness.dashboard.agents.terminal.send"
  static let dashboardTerminalControlCButton = "harness.dashboard.agents.terminal.ctrl-c"
  static let dashboardTerminalSignalCommandField =
    "harness.dashboard.agents.terminal.signal.command"
  static let dashboardTerminalSignalMessageField =
    "harness.dashboard.agents.terminal.signal.message"
  static let dashboardTerminalSignalSendButton = "harness.dashboard.agents.terminal.signal.send"
  static let dashboardTerminalOutput = "harness.dashboard.agents.terminal.output"
  static let dashboardTerminalStopButton = "harness.dashboard.agents.terminal.stop"
  static let dashboardTerminalRemoveButton = "harness.dashboard.agents.terminal.remove"
  static let dashboardCodexCreateButton = "harness.dashboard.agents.codex.create"
  static let dashboardCodexCreateSheet = "harness.dashboard.agents.codex.create.sheet"
  static let dashboardCodexWorkspacePicker = "harness.dashboard.agents.codex.create.workspace"
  static let dashboardCodexNameField = "harness.dashboard.agents.codex.create.name"
  static let dashboardCodexPromptField = "harness.dashboard.agents.codex.create.prompt"
  static let dashboardCodexStartButton = "harness.dashboard.agents.codex.create.start"
  static let dashboardCodexSteerField = "harness.dashboard.agents.codex.steer.field"
  static let dashboardCodexSteerButton = "harness.dashboard.agents.codex.steer.send"
  static let dashboardCodexInterruptButton = "harness.dashboard.agents.codex.interrupt"
  static let dashboardCodexStopButton = "harness.dashboard.agents.codex.stop"
  ...
  static let dashboardAuditDetailDivider =
