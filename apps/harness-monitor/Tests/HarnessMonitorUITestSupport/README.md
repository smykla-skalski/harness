...
When a macOS UI test fails because a title, button, or field is "missing", do not invent a new accessibility/query pattern first. Start by finding the nearest working surface in this app and match its structure.
