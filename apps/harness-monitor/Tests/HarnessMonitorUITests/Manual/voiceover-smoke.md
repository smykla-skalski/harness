...
2. With VoiceOver running, confirm the ACP toast announces **"Permission requested by … workspace window."** once, exposes **Open Workspace** and **Dismiss**, and does not trap focus.
