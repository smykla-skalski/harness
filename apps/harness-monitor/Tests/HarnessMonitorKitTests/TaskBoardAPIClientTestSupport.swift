...
private let taskBoardRPCResponses: [WebSocketRPCMethod: JSONValue] = [
  ...
  .taskBoardPolicyScenarioCreate: .object(samplePolicyCanvasWorkspaceJSON),
  .taskBoardPolicyScenarioUpdate: .object(samplePolicyCanvasWorkspaceJSON),
  .taskBoardPolicyScenarioDelete: .object(samplePolicyCanvasWorkspaceJSON),
  .taskBoardPolicyScenarioReset: .object(samplePolicyCanvasWorkspaceJSON),
...
final class TaskBoardURLProtocol: URLProtocol, @unchecked Sendable {
  ...
  private static let responseBodies: [Route: String] = [
    ...
    Route("/v1/task-board/policy/scenarios/create"): samplePolicyCanvasWorkspaceText,
    Route("/v1/task-board/policy/scenarios/update"): samplePolicyCanvasWorkspaceText,
    Route("/v1/task-board/policy/scenarios/delete"): samplePolicyCanvasWorkspaceText,
    Route("/v1/task-board/policy/scenarios/reset"): samplePolicyCanvasWorkspaceText,
