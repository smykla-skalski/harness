...
struct DashboardReviewFilesSoftWrapContractTests {
  ...
  func filesSettingsExposeSoftWrapToggle() throws {
    let source = try previewableSourceFile(named: "Views/Settings/SettingsReviewsFilesSection.swift")
  ...
  func filesHeaderExposesSoftWrapToggle() throws {
    let source = try previewableSourceFile(named: "Views/Dashboard/DashboardReviewFilesHeader.swift")
  ...
  @Test("Files detail pane exposes the in-view soft-wrap toggle and routes renders through the preference")
  func filesDetailPaneExposesSoftWrapToggle() throws {
    let source = try previewableSourceFile(named: "Views/Dashboard/DashboardReviewFilesModeDetailPane.swift")
