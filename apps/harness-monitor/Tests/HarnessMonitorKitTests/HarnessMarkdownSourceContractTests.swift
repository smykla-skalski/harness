...
struct HarnessMarkdownSourceContractTests {
  ...
  func markdownRendererDoesNotDependOnRemovedPackageOrFeatureFlag() throws {
    ...
    let files = [
      "apps/harness-monitor/Tuist/Package.swift",
      "apps/harness-monitor/Tuist/ProjectDescriptionHelpers/FeatureFlags.swift",
      """
      apps/harness-monitor/Sources/HarnessMonitorUIPreviewable/Views/Shared/\
      HarnessMonitorMarkdownText.swift
      """,
      """
      apps/harness-monitor/Sources/HarnessMonitorUIPreviewable/Views/TaskBoard/\
    ...
    #expect(
      !FileManager.default.fileExists(
        atPath: repositoryPath("apps/harness-monitor/features/" + "text" + "ual.yml")))
  }
  ...
  func markdownParserSupportStaysScannerBased() throws {
    ...
    let supportRoot = repositoryPath(
      "apps/harness-monitor/Sources/HarnessMonitorUIPreviewable/Support/Markdown"
    )
