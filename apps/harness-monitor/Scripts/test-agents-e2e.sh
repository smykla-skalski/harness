...
TERMINAL_SESSION_ID="${HARNESS_MONITOR_E2E_TERMINAL_SESSION_ID:-$(uuidgen | tr '[:upper:]' '[:lower:]')}"
CODEX_SESSION_ID="${HARNESS_MONITOR_E2E_CODEX_SESSION_ID:-$(uuidgen | tr '[:upper:]' '[:lower:]')}"
