...
struct HarnessMonitorFeedbackToastRow: View {
  ...
  @ViewBuilder private var activitySpinner: some View {
    if feedback.severity == .activity {
      ProgressView()
        .controlSize(.small)
        .tint(tintColor)
  ...
  private var tintColor: Color {
    switch feedback.severity {
    case .activity: HarnessMonitorTheme.accent
