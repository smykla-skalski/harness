...
@MainActor
@Observable
final class DashboardAcpAgentDetailState {
  private(set) var detail: DashboardAcpAgentDetail?
  private(set) var isLoading = false
  private(set) var activeAction: String?
  var prompt = ""
  private var generation: UInt64 = 0

  init(detail: DashboardAcpAgentDetail? = nil) {
    self.detail = detail
  }
  ...
  func finishLoad(_ detail: DashboardAcpAgentDetail, generation expected: UInt64) {
