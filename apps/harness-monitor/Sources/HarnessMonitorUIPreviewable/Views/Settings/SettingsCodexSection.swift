...
public struct SettingsHostBridgeSection: View {
  ...
  private func activeBody(
    ...
    .accessibilityIdentifier(HarnessMonitorAccessibility.settingsAgentsSection)
  }
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: HarnessMonitorTheme.sectionSpacing) {
      commandRow(
        ...
        accessibilityID: HarnessMonitorAccessibility.settingsAgentsCopyStartButton
      )
      commandRow(
        title: "Auto-start at login",
        description: "Install as a login item for persistent auto-start",
        command: installCommand,
        accessibilityID: HarnessMonitorAccessibility.settingsAgentsCopyInstallButton
      )
    }
  }
