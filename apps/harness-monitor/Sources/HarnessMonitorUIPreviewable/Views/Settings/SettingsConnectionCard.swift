...
struct SettingsConnectionMetrics: View {
  let metrics: ConnectionMetrics
  let events: [ConnectionEvent]

  var body: some View {
    SettingsConnectionMetricsSection(metrics: metrics)

    if !events.isEmpty {
      SettingsConnectionRecentEventsSection(events: events)
    }
  }
}

private struct SettingsConnectionMetricsSection: View {
  let metrics: ConnectionMetrics
  ...
  var body: some View {
    Section {
      ...
      LabeledContent("Uptime") {
        SettingsConnectionUptimeValue(connectedSince: metrics.connectedSince)
      }
...
private struct SettingsConnectionRecentEventsSection: View {
  let events: [ConnectionEvent]
...
private struct SettingsConnectionUptimeValue: View {
