...
public enum HarnessMonitorVoiceSettingsDefaults {
...
public struct HarnessMonitorVoiceSettings: Equatable, Sendable {
  ...
  public static func registrationDefaults(
    ...
    [
      HarnessMonitorVoiceSettingsDefaults.localeIdentifierKey: localeIdentifier,
      HarnessMonitorVoiceSettingsDefaults.localDaemonSinkEnabledKey: true,
      HarnessMonitorVoiceSettingsDefaults.agentBridgeSinkEnabledKey: true,
      HarnessMonitorVoiceSettingsDefaults.remoteProcessorSinkEnabledKey: false,
      HarnessMonitorVoiceSettingsDefaults.remoteProcessorURLKey: "",
      ...
      HarnessMonitorVoiceSettingsDefaults.deliversAudioChunksKey: true,
      HarnessMonitorVoiceSettingsDefaults.pendingAudioChunkLimitKey:
  ...
  public static func stored(defaults: UserDefaults = .standard) -> Self {
    Self(
      localeIdentifier: defaults.string(
        forKey: HarnessMonitorVoiceSettingsDefaults.localeIdentifierKey)
        ?? defaultLocaleIdentifier,
      localDaemonSinkEnabled: defaults.object(
        forKey: HarnessMonitorVoiceSettingsDefaults.localDaemonSinkEnabledKey
      ) as? Bool ?? true,
      agentBridgeSinkEnabled: defaults.object(
        forKey: HarnessMonitorVoiceSettingsDefaults.agentBridgeSinkEnabledKey
      ) as? Bool ?? true,
      remoteProcessorSinkEnabled: defaults.object(
        forKey: HarnessMonitorVoiceSettingsDefaults.remoteProcessorSinkEnabledKey
      ) as? Bool ?? false,
      ...
      deliversAudioChunks: defaults.object(
        forKey: HarnessMonitorVoiceSettingsDefaults.deliversAudioChunksKey
      ) as? Bool ?? true,
      pendingAudioChunkLimit: defaults.object(
        forKey: HarnessMonitorVoiceSettingsDefaults.pendingAudioChunkLimitKey
