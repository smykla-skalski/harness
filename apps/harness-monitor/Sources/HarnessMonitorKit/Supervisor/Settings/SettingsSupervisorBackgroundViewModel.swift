...
@MainActor
@Observable
public final class SettingsSupervisorBackgroundViewModel {
  ...
  public init(
    ...
    let quietHoursStartMinutes = storedMinutes(
      forKey: SupervisorSettingsDefaults.quietHoursStartMinutesKey,
      defaultValue: SupervisorSettingsDefaults.quietHoursStartMinutesDefault
    )
    let quietHoursEndMinutes = storedMinutes(
      forKey: SupervisorSettingsDefaults.quietHoursEndMinutesKey,
      defaultValue: SupervisorSettingsDefaults.quietHoursEndMinutesDefault
    )
    let runInBackgroundObject = userDefaults.object(
      forKey: SupervisorSettingsDefaults.runInBackgroundKey
    )
    runInBackground =
      (runInBackgroundObject as? Bool) ?? SupervisorSettingsDefaults.runInBackgroundDefault
    let quietHoursObject = userDefaults.object(
      forKey: SupervisorSettingsDefaults.quietHoursEnabledKey
    )
    quietHoursEnabled =
      (quietHoursObject as? Bool) ?? SupervisorSettingsDefaults.quietHoursEnabledDefault
    quietHoursStart = SupervisorQuietHoursWindow(
      startMinutes: quietHoursStartMinutes,
      endMinutes: SupervisorSettingsDefaults.quietHoursEndMinutesDefault
    ).startDate(reference: now, calendar: calendar)
    quietHoursEnd = SupervisorQuietHoursWindow(
      startMinutes: SupervisorSettingsDefaults.quietHoursStartMinutesDefault,
  ...
  public func setRunInBackground(_ enabled: Bool) {
    ...
    userDefaults.set(enabled, forKey: SupervisorSettingsDefaults.runInBackgroundKey)
  ...
  public func setQuietHoursEnabled(_ enabled: Bool) {
    ...
    userDefaults.set(enabled, forKey: SupervisorSettingsDefaults.quietHoursEnabledKey)
