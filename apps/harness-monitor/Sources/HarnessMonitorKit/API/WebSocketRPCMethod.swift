...
enum WebSocketRPCMethod: String, CaseIterable, Equatable, Sendable {
  ...
  case taskBoardPolicyScenarioCreate = "task_board.policy_scenario_create"
  case taskBoardPolicyScenarioUpdate = "task_board.policy_scenario_update"
  case taskBoardPolicyScenarioDelete = "task_board.policy_scenario_delete"
  case taskBoardPolicyScenarioReset = "task_board.policy_scenario_reset"
  ...
  case taskBoardPolicyPipelineMakeLive = "task_board.policy_pipeline_make_live"
  case taskBoardPolicyPipelineGoLiveDiff = "task_board.policy_pipeline_go_live_diff"
  case taskBoardPolicyPipelineReplay = "task_board.policy_pipeline_replay"
