...
enum WebSocketRPCMethod: String, CaseIterable, Equatable, Sendable {
  ...
  case agentWorkspaceTeam = "agent_workspace.team"
  case agentWorkspaceMemberRemove = "agent_workspace.member.remove"
  case agentWorkspaceActivity = "agent_workspace.activity"
  case agentWorkspaceMemberActivity = "agent_workspace.member.activity"
  case agentWorkspaceSignalSend = "agent_workspace.signal.send"
  case agentWorkspaceSignalAck = "agent_workspace.signal.ack"
  case agentWorkspaceSignalCancel = "agent_workspace.signal.cancel"
  ...
  case taskBoardCapabilities = "task_board.capabilities"
  case taskBoardList = "task_board.list"
  case taskBoardGet = "task_board.get"
  case taskBoardReviewReportGet = "task_board.review_report_get"
  case taskBoardWorkflowProgressGet = "task_board.workflow_progress_get"
  case taskBoardProgressGet = "task_board.progress_get"
  case taskBoardProgressReport = "task_board.progress_report"
  case taskBoardPositionGet = "task_board.position_get"
  case taskBoardPositionSet = "task_board.position_set"
  ...
  case taskBoardTriageRulesDraftGet = "task_board.triage_rules_draft_get"
  case taskBoardTriageRulesDraftSave = "task_board.triage_rules_draft_save"
  case taskBoardTriageRulesPreview = "task_board.triage_rules_preview"
  case taskBoardTriageRulesActivate = "task_board.triage_rules_activate"
  case taskBoardTriageRulesRevisions = "task_board.triage_rules_revisions"
  case taskBoardTriageRulesAudit = "task_board.triage_rules_audit"
  ...
  case taskBoardSyncCancel = "task_board.sync.cancel"
  case taskBoardSyncStatus = "task_board.sync.status"
  case taskBoardDispatch = "task_board.dispatch"
  case taskBoardDispatchPick = "task_board.dispatch_pick"
  case taskBoardDispatchDeliver = "task_board.dispatch_deliver"
  case taskBoardEvaluate = "task_board.evaluate"
  case taskBoardAudit = "task_board.audit"
  case taskBoardProjects = "task_board.projects"
  case taskBoardProjectsUpdate = "task_board.projects_update"
  ...
  case taskBoardWorkingCopiesList = "task_board.working_copies_list"
  case taskBoardWorkingCopiesObtain = "task_board.working_copies_obtain"
  case taskBoardWorkingCopiesDelete = "task_board.working_copies_delete"
  ...
  case taskBoardOrchestratorRuns = "task_board.orchestrator_runs"
  case taskBoardOrchestratorRunDetail = "task_board.orchestrator_run_detail"
  case taskBoardOrchestratorMetrics = "task_board.orchestrator_metrics"
  case taskBoardOrchestratorForceCancel = "task_board.orchestrator_force_cancel"
  ...
  case taskBoardGitRuntimeKeyMaterialSync = "task_board.git_runtime_key_material_sync"
  case taskBoardGitRuntimeSecretHandoffPrepare =
    "task_board.git_runtime_secret_handoff_prepare"
  case taskBoardGitRuntimeSecretHandoffAck = "task_board.git_runtime_secret_handoff_ack"
  case policyCanvasWorkspaceGet = "policy_canvas.workspace_get"
  case policyCanvasCreate = "policy_canvas.create"
  case policyCanvasDuplicate = "policy_canvas.duplicate"
  case policyCanvasRename = "policy_canvas.rename"
  case policyCanvasSetActive = "policy_canvas.set_active"
  case policyCanvasDelete = "policy_canvas.delete"
  case policyCanvasSetEnforcement = "policy_canvas.set_global_enforcement"
  case policyCanvasSetSpawnRequiresLivePolicy =
  ...
  case policyScenarioReset = "policy_scenario.reset"
  case policyPipelineGet = "policy_pipeline.get"
  case policyPipelineSaveDraft = "policy_pipeline.save_draft"
  case policyPipelineSimulate = "policy_pipeline.simulate"
  case policyPipelinePromote = "policy_pipeline.promote"
  case policyPipelineMakeLive = "policy_pipeline.make_live"
  case policyPipelineGoLiveDiff = "policy_pipeline.go_live_diff"
  case policyPipelineReplay = "policy_pipeline.replay"
  case policyPipelineAudit = "policy_pipeline.audit"
  case policyCanvasExport = "policy_canvas.export"
  case policyCanvasImport = "policy_canvas.import"
  ...
  case managedAgentAcpSessions = "managed_agent.acp_sessions"
  case managedAgentCloseAcpSession = "managed_agent.close_acp_session"
  case managedAgentDeleteAcpSession = "managed_agent.delete_acp_session"
  case managedAgentLogoutAcp = "managed_agent.logout_acp"
