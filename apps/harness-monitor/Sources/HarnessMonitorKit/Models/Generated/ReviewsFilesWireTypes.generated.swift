// Generated by examples/policy-codegen.rs from the Rust reviews file list, patch, preview, blob and viewed types
...
public struct ReviewsFilesPatchRequestWire: Codable, Equatable, Sendable {
  ...
  public var headRefName: String?
  public var baseRefName: String?
  public var largeDiffStrategy: FilesLargeDiffStrategy?

  public init(pullRequestId: String, headRefOidExpected: String, paths: [String], number: UInt64? = nil, repositoryFullName: String? = nil, baseRefOidExpected: String? = nil, headRefName: String? = nil, baseRefName: String? = nil, largeDiffStrategy: FilesLargeDiffStrategy? = nil) {
    self.pullRequestId = pullRequestId
