// Generated by examples/policy-codegen.rs from the Rust reviews wire enums
...
public enum ReviewActionKind: TaskBoardOpenEnum, CaseIterable, Identifiable {
  ...
  public static let allCases: [Self] = [.approve, .merge, .rerunChecks, .addLabel, .autoApprove, .autoMerge, .comment, .requestReview]
