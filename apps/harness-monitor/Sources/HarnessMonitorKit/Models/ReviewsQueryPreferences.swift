...
public struct ReviewsQueryPreferences: Equatable, Sendable {
  ...
  public static func normalizedEntries(_ text: String) -> [String] {
    text
...
public struct ReviewsQueryPreferenceStore: @unchecked Sendable {
  private let defaults: UserDefaults
  private let storageKey: String

  public init(
    defaults: UserDefaults = .standard,
    storageKey: String = ReviewsQueryPreferences.storageKey
  ) {
