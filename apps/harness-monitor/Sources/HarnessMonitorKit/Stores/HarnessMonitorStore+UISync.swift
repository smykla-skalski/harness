...
extension HarnessMonitorStore {
  ...
  private func syncContentToolbarUI() {
    ...
    assign(manualRefreshSuccessToken, to: \.manualRefreshSuccessToken, on: contentUI.toolbar)
  }
  ...
  private func syncContentDashboardUI() {
    contentUI.dashboard.apply(
      ContentDashboardState(
        ...
        taskBoardItemsSnapshotAvailable: globalTaskBoardItemsSnapshotAvailable,
