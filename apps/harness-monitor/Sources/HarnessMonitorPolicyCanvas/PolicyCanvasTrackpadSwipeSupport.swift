...
extension EnvironmentValues {
  ...
  /// canvas route stops reserving a swipe region, so hidden routes cannot block
  /// history navigation in the visible window content.
...
extension View {
  ...
  /// so history-swipe gestures yield while the pointer is over the canvas.
...
private final class HarnessTrackpadSwipeOptOutMarkerView: NSView {
  var isActive = true {
...
@MainActor
private final class HarnessTrackpadSwipeOptOutRegistry {
