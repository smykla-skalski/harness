...
private let monitorAppSources: SourceFilesList = SourceFilesList(
  globs: [
    .glob(
      "Sources/HarnessMonitor/**/*.swift",
      excluding: [
        "Sources/HarnessMonitor/Features/**"
      ])
  ] + FeatureFlags.appAdditionalSourceGlobs(target: "HarnessMonitor"))

private let uiPreviewableSources: SourceFilesList = SourceFilesList(
  globs: [
    .glob(
      "Sources/HarnessMonitorUIPreviewable/**/*.swift",
      excluding: [
...
private let kitSources: SourceFilesList = SourceFilesList(
  globs: [
    .glob(
      "Sources/HarnessMonitorKit/**/*.swift", excluding: ["Sources/HarnessMonitorKit/Features/**"])
...
private let policyCanvasSources: SourceFilesList = SourceFilesList(globs: [
  ...
  .glob(
    "Sources/HarnessMonitorUIPreviewable/Support/HarnessMonitorAccessibilityIDs+PolicyCanvas.swift"),
  .glob(
    "Sources/HarnessMonitorUIPreviewable/Support/HarnessMonitorAccessibilityPolicyCanvas.swift"),
...
private let policyCanvasLabHostTarget: Target = .target(
  ...
  deploymentTargets: macOSDeploymentTargets,
  infoPlist: .file(path: "Resources/HarnessMonitorPolicyCanvasLab-Info.plist"),
  ...
  settings: .settings(base: [
    ...
    "CODE_SIGN_STYLE": "Automatic",
    "GENERATE_INFOPLIST_FILE": "NO",
    "INFOPLIST_FILE": "Resources/HarnessMonitorPolicyCanvasLab-Info.plist",
...
private let appTestsSources: SourceFilesList = SourceFilesList(globs: [
  .glob(
    "Tests/HarnessMonitorAppTests/**/*.swift",
    excluding: [
...
private let kitTestsSources: SourceFilesList = SourceFilesList(
  globs: [
    .glob(
...
private let policyCanvasAlgorithmTestsTarget: Target = .target(
  ...
  metadata: .metadata(tags: [
    "tag:feature:monitor", "tag:feature:policy-canvas", "tag:feature:algorithms", "tag:layer:test",
  ])
)
...
private let monitorRunEnv: [String: EnvironmentVariable] = [
  ...
  "OTEL_EXPORTER_OTLP_ENDPOINT": .environmentVariable(
    value: "http://127.0.0.1:4317", isEnabled: true),
