...
enum HarnessMonitorTextSize {
  static let storageKey = "harnessTextSize"
  static let uiTestOverrideKey = "HARNESS_MONITOR_TEXT_SIZE_OVERRIDE"
...
extension EnvironmentValues {
  ...
  @Entry var harnessTextSizeIndex: Int = HarnessMonitorTextSize.defaultIndex
