...
enum WebSocketRPCMethod: String, CaseIterable, Equatable, Sendable {
  ...
  case dependencyUpdatesCapabilities = "dependency_updates.capabilities"
  case dependencyUpdatesQuery = "dependency_updates.query"
  case dependencyUpdatesActionPreview = "dependency_updates.action_preview"
  case dependencyUpdatesApprove = "dependency_updates.approve"
  case dependencyUpdatesMerge = "dependency_updates.merge"
  case dependencyUpdatesRerunChecks = "dependency_updates.rerun_checks"
  case dependencyUpdatesAddLabel = "dependency_updates.add_label"
  case dependencyUpdatesAuto = "dependency_updates.auto"
  case dependencyUpdatesClearCache = "dependency_updates.clear_cache"
  case dependencyUpdatesRefresh = "dependency_updates.refresh"
  ...
  case dependencyUpdatesTimeline = "dependency_updates.timeline"
  case dependencyUpdatesReviewThreadsResolve = "dependency_updates.review_threads_resolve"
