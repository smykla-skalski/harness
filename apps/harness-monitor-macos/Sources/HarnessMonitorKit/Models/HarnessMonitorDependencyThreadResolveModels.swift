...
/// Request body for the `/v1/dependency-updates/review-threads/resolve`
/// HTTP route (and matching WS method). Mirrors the Rust
/// `DependencyUpdatesReviewThreadResolveRequest`:
...
public struct DependencyUpdatesReviewThreadResolveRequest: Codable, Equatable, Sendable {
...
public struct DependencyUpdatesReviewThreadResolveResponse: Codable, Equatable, Sendable {
  public let threadId: String
  public let resolved: Bool
