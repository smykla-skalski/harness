...
@MainActor
@Observable
public final class SettingsSupervisorRulesViewModel {
  ...
  public init(rules: [any PolicyRule] = HarnessMonitorSupervisorRuleCatalog.makeRules()) {
    self.rules = rules.map(SettingsSupervisorRuleDescriptor.init(rule:))
  ...
  public var selectedRule: SettingsSupervisorRuleDescriptor? {
    ...
    -> PolicyConfigRowSnapshot
  {
    guard
      ...
      throw SettingsSupervisorRulesViewModelError.noRuleSelected
    }
