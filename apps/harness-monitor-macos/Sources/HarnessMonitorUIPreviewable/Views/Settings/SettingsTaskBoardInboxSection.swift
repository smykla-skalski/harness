  ...
  var body: some View {
    Section {
      SettingsTaskBoardInboxEntryList(
        title: "Repositories",
        valueTitle: "Repository",
        entries: draft.githubInboxRepositoryEntries,
        emptyTitle: "No repositories added",
        emptySystemImage: "tray",
        inputPlaceholder: "owner/repo",
        input: $draft.githubInboxRepositoryInput,
        addTitle: "Add Repository",
        addAccessibilityIdentifier:
          HarnessMonitorAccessibility.settingsTBInboxRepoAddButton,
        ...
        rowAccessibilityIdentifier:
          HarnessMonitorAccessibility.settingsTBInboxRepoRow,
        removeAccessibilityIdentifier:
          HarnessMonitorAccessibility.settingsTBInboxRepoRemoveButton,
