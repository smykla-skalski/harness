...
private enum SettingsBackgroundGalleryRecents {
  static func items(
  ...
  static func stateLabel(for recentItems: [HarnessMonitorBackgroundSelection]) -> String {
    "recent=\(recentItems.map(\.settingsStateValue).joined(separator: "|"))"
  }
}
...
struct SettingsBackgroundGallery: View {
  ...
  private var recentStateLabel: String {
    SettingsBackgroundGalleryRecents.stateLabel(for: recentItems)
  }
  ...
  var body: some View {
    Group {
      if isBackdropDisabled {
        ...
        .accessibilityIdentifier(HarnessMonitorAccessibility.settingsBackgroundGallery)
    ...
    .overlay {
      if HarnessMonitorUITestEnvironment.accessibilityMarkersEnabled {
        AccessibilityTextMarker(
          identifier: HarnessMonitorAccessibility.settingsBackgroundRecentState,
  ...
  private var recentBackgroundsRow: some View {
    ...
    .accessibilityElement(children: .contain)
    .accessibilityIdentifier(HarnessMonitorAccessibility.settingsBackgroundRecentsSection)
  }
...
private struct SettingsBackgroundTile: View {
  ...
  var body: some View {
    ...
    .accessibilityIdentifier(
      HarnessMonitorAccessibility.settingsBackgroundTile(background.accessibilityKey)
    )
