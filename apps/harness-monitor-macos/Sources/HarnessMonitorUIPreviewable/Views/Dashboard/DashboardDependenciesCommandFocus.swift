...
public struct DashboardDependenciesCommandFocus: Equatable, @unchecked Sendable {
...
private struct DashboardDependenciesCommandFocusKey: FocusedValueKey {
  typealias Value = DashboardDependenciesCommandFocus
}

extension FocusedValues {
  public var dashboardDependenciesCommands: DashboardDependenciesCommandFocus? {
    get { self[DashboardDependenciesCommandFocusKey.self] }
    set { self[DashboardDependenciesCommandFocusKey.self] = newValue }
  }
}
