...
@MainActor
struct DashboardDependenciesProvenanceSnapshot: Equatable {
  ...
  init(
    ...
    syncHealth: DashboardDependenciesSyncHealth,
  ...
  var fetchedAgeTitle: String {
    ...
    return dependenciesRelativeFormatter.localizedString(for: fetchedDate, relativeTo: .now)
  }
...
extension DashboardDependenciesRouteView {
  var routeProvenanceSnapshot: DashboardDependenciesProvenanceSnapshot {
...
struct DashboardDependenciesProvenanceBar: View {
  let snapshot: DashboardDependenciesProvenanceSnapshot
  let onRefresh: () -> Void
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: HarnessMonitorTheme.spacingSM) {
      HStack(alignment: .firstTextBaseline, spacing: HarnessMonitorTheme.spacingSM) {
        ...
        .help("Refresh dependency data")
        .accessibilityLabel("Refresh dependency data")
      }
    ...
    .accessibilityIdentifier(HarnessMonitorAccessibility.dashboardDependenciesProvenance)
    .accessibilityElement(children: .combine)
    .accessibilityLabel("Dependency data provenance")
    .accessibilityValue(snapshot.detailTitle)
  }
}

struct DashboardDependencyProvenanceMiniBar: View {
  let snapshot: DashboardDependenciesProvenanceSnapshot
  ...
  var body: some View {
    ...
    .lineLimit(1)
    .accessibilityElement(children: .combine)
    .accessibilityLabel("Dependency data source")
    .accessibilityValue(snapshot.detailTitle)
  }
}
