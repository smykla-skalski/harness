...
/// result when it returns first; throws `DashboardDependenciesSchedulerError`
/// `.fetchTimedOut` when the timeout fires first.
///
/// Used by the dependency scheduler, refresh, and per-PR action paths so a
...
enum DashboardDependenciesTimeoutRacer {
