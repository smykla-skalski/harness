...
@MainActor
struct DashboardDependenciesCustomLabelSheet: View {
  let items: [DependencyUpdateItem]
  let suggestions: [DependencyUpdateRepositoryLabel]
  ...
  var body: some View {
    ...
    .accessibilityIdentifier(
      HarnessMonitorAccessibility.dashboardDependenciesCustomLabelSheet
    )
  }
  ...
  private var labelField: some View {
    VStack(alignment: .leading, spacing: HarnessMonitorTheme.spacingXS) {
      ...
      TextField("e.g. dependencies", text: $draft)
        ...
        .accessibilityIdentifier(
          HarnessMonitorAccessibility.dashboardDependenciesCustomLabelField
        )
  ...
  private var footer: some View {
    HStack(spacing: HarnessMonitorTheme.itemSpacing) {
      ...
      HarnessMonitorActionButton(
        ...
        variant: .bordered,
        accessibilityIdentifier:
          HarnessMonitorAccessibility.dashboardDependenciesCustomLabelCancel
      ) {
        onCancel()
      }
      HarnessMonitorActionButton(
        ...
        variant: .prominent,
        accessibilityIdentifier:
          HarnessMonitorAccessibility.dashboardDependenciesCustomLabelApply
      ) {
        applyIfPossible()
      }
      .disabled(!canApply)
