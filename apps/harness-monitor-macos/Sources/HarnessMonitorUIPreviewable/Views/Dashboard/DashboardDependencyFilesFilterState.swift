...
/// View-local @Observable holder for the Dependencies > Files filter
...
@Observable
@MainActor
final class DashboardDependencyFilesFilterState {
  var text: String = "" {
  ...
  var generatedPathMatcher: DependencyUpdateFilesGeneratedPathMatcher = .empty {
    didSet { publishSnapshot() }
  }
  ...
  private func makeSnapshot() -> DependencyUpdateFilesFilter {
