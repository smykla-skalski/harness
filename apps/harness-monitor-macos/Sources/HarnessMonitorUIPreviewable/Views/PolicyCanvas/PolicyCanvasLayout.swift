...
/// Geometry constants used across the policy canvas. Pulled out of
/// `PolicyCanvasTypes.swift` so the types file stays under the 420-line cap;
/// the constants themselves are unchanged.
