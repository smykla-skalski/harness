...
# shellcheck source=apps/harness-monitor-macos/Scripts/lib/local-harness-binary.sh
...
binary="$(resolve_local_harness_binary "$CHECKOUT_ROOT" HARNESS_MONITOR_BRIDGE_START_BIN)"
