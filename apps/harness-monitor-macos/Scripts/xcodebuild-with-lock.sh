...
# Default to wait-until-acquired for xcodebuild lock contention.
# Set XCODEBUILD_LOCK_WAIT_TIMEOUT_SECONDS>0 to restore fail-fast timeout.
LEASE_LOCK_WAITER_TIMEOUT_SECONDS="${XCODEBUILD_LOCK_WAIT_TIMEOUT_SECONDS:-0}"
