extension HarnessMonitorUITestAccessibility {
  static let createTaskSheet = "harness.action.create-task.sheet"
  ...
  static let sessionAgentCreateOpenButton = "harness.session.agents.create-agent.open"
  static let sessionTaskCreateOpenButton = "harness.session.tasks.create-task.open"
  ...
  static let assignTaskButton = "harness.action.task.assign"
  ...
  static let manageTaskOpenButton = "harness.session.task.manage-open"
  ...
  static let leaderTransferOpenButton = "harness.session.header.leader-transfer.open"
  static let leaderTransferSection = "harness.action.leader-transfer.section"
  static let leaderTransferPicker = "harness.action.leader-transfer.picker"
}
