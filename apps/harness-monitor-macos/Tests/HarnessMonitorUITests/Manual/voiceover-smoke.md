...
2. With VoiceOver running, confirm the ACP toast announces **"Permission requested by … Decisions window."** once, exposes **Open Decisions** and **Dismiss permission alert**, and does not trap focus.
3. Activate **Open Decisions** from the toast and confirm the Decisions window becomes key and VoiceOver lands on the decision's primary action.
