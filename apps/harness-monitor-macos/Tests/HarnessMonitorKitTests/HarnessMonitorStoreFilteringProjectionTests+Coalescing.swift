...
extension HarnessMonitorStoreProjectionTests {
  ...
  func projectionSummaryUpdateOnlyResyncsToolbarWhenSelectionIsEmpty() {
    ...
    let updated = SessionSummary(
      ...
      sharedPath: active.sharedPath,
      originPath: active.originPath,
      branchRef: active.branchRef,
      title: active.title,
  ...
  func summaryOnlyUpdateSkipsContentResyncForUnselectedSession() {
    ...
    let updated = SessionSummary(
      ...
      worktreePath: paused.worktreePath,
      sharedPath: paused.sharedPath,
      originPath: paused.originPath,
      branchRef: paused.branchRef,
      title: paused.title,
