...
struct SessionWindowCreateFormMetricsTests {
  ...
  func createFormKeepsFocusAndCancelAffordancesInSource() throws {
    ...
    #expect(source.contains("SessionWindowCreateProviderButtonList("))
    #expect(source.contains("Text(\"Create\")"))
  ...
  func runtimeConfigurationSupportIsSplitBetweenCatalogAndPaneSources() throws {
    ...
    #expect(formSource.contains("codexConfigurationSection"))
    #expect(formSource.contains("SessionWindowCreateProviderButtonList("))
