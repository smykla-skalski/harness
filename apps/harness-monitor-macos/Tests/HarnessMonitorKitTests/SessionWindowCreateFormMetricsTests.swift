...
struct SessionWindowCreateFormMetricsTests {
  ...
  func createFormKeepsFocusAndCancelAffordancesInSource() throws {
    ...
    #expect(source.contains("LabeledContent(\"Prompt\")"))
    #expect(source.contains("Spacer(minLength: 0)"))
    #expect(source.contains("Text(draft.kind.title)"))
    #expect(source.contains("TextField(\"\", text: title)"))
    #expect(source.contains(".harnessActionButtonStyle(variant: .bordered, tint: .secondary)"))
    #expect(source.contains(".controlSize(HarnessMonitorControlMetrics.compactControlSize)"))
    ...
    #expect(!themeSource.contains("HarnessMonitorNativeTextFieldChromeMetrics"))
    #expect(!themeSource.contains("HarnessMonitorNativeTextFieldConfiguration"))
    ...
    #expect(themeSource.contains(".textFieldStyle(.roundedBorder)"))
    #expect(themeSource.contains(".frame(maxWidth: .infinity)"))
    ...
    #expect(multilineSource.contains(".multilineTextAlignment(.leading)"))
