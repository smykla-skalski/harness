...
private let sampleTaskBoardItemJSON: [String: JSONValue] = [
...
private let sampleTaskBoardDispatchSummaryJSON: [String: JSONValue] = [
  "plans": .array([
    .object([
...
private let sampleTaskBoardItemJSONString =
  """
  {
    "schema_version": 1,
    "id": "board-1",
...
private let sampleTaskBoardDispatchSummaryJSONString =
  """
  {
    "plans": [
      {
