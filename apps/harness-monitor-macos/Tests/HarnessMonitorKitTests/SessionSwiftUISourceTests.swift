...
struct SessionSwiftUISourceTests {
  ...
  func timelineRouteHeaderKeepsFilterActionsInlineAndRemovesSearchScopeMenu() throws {
    ...
    let blurSource = try sourceFile(at: "Views/Timeline/SessionTimelineScrollEdgeEffect.swift")
    ...
    #expect(timelineSource.contains("private var routeTimelineTopScrollEdgeBlurHeight"))
    #expect(timelineSource.contains("private var routeTimelineBottomScrollEdgeBlurHeight"))
    ...
    #expect(timelineSource.contains("topScrollEdgeBlurHeight: routeTimelineTopScrollEdgeBlurHeight"))
    #expect(timelineSource.contains("bottomScrollEdgeBlurHeight: routeTimelineBottomScrollEdgeBlurHeight"))
    ...
    #expect(placeholderSource.contains(".scrollEdgeEffectStyle(.soft, for: .top)"))
    #expect(placeholderSource.contains(".scrollEdgeEffectStyle(.soft, for: .bottom)"))
    #expect(tableSource.contains("let horizontalContentInset: CGFloat"))
    #expect(tableSource.contains("let topScrollEdgeBlurHeight: CGFloat"))
    #expect(tableSource.contains("let bottomScrollEdgeBlurHeight: CGFloat"))
    #expect(tableSource.contains("SessionTimelineTableScrollView()"))
    #expect(tableSource.contains("updateScrollEdgeEffectHeights("))
    #expect(blurSource.contains("blendingMode = .withinWindow"))
    #expect(blurSource.contains("material = .headerView"))
    #expect(blurSource.contains("state = .active"))
    #expect(blurSource.contains("override func hitTest"))
    #expect(blurSource.contains("maskImage = makeMaskImage"))
  }
