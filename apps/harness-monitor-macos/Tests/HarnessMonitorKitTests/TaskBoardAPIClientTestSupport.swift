...
private let taskBoardRPCResponses: [WebSocketRPCMethod: JSONValue] = [
  ...
  .taskBoardOrchestratorGitHubTokensSync: .object(sampleTaskBoardGitHubTokensSyncResponseJSON),
...
final class TaskBoardURLProtocol: URLProtocol, @unchecked Sendable {
  ...
  private static let responseBodies: [Route: String] = [
    ...
    Route("/v1/task-board/orchestrator/github-tokens"): sampleTaskBoardGitHubTokensSyncResponseText,
