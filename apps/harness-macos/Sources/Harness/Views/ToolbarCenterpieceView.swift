...
enum ToolbarCenterpieceDisplayMode: String {
  ...
  var interSectionSpacing: CGFloat {
    switch self {
    case .standard:
      HarnessTheme.spacingLG
    case .compact:
      6
    case .compressed:
      HarnessTheme.spacingXS
    }
  }
  ...
  var metricSpacing: CGFloat {
    switch self {
    case .standard:
      HarnessTheme.spacingMD
    case .compact:
      HarnessTheme.spacingSM
    case .compressed:
      HarnessTheme.spacingXS
    }
  }
...
private struct ToolbarCenterpieceView: View {
  ...
  var body: some View {
    ...
    .accessibilityIdentifier(HarnessAccessibility.toolbarCenterpiece)
  ...
  private var leadingSection: some View {
    HStack(spacing: displayMode.leadingSpacing) {
      ...
      if displayMode.showsDestinationName {
        HStack(spacing: HarnessTheme.spacingXS) {
