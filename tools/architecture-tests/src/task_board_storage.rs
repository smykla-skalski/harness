...
fn live_task_board_consumers_do_not_reopen_legacy_storage() {
    ...
    let paths = [
        ...
        "crates/harness-daemon/src/daemon/serve/machine_heartbeat_loop.rs",
        "crates/harness-daemon/src/daemon/serve/task_board_dispatch_loop.rs",
        "crates/harness-daemon/src/daemon/serve/task_board_orchestrator_loop.rs",
