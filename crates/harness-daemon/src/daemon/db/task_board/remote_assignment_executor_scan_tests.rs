...
fn distinct_scan_offer(index: usize) -> crate::task_board::remote_wire::wire::RemoteOfferRequest {
    ...
    request.launch = crate::task_board::remote_wire::wire::test_codex_launch(
