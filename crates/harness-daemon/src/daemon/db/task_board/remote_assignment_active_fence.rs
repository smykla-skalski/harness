...
#[cfg(test)]
#[path = "remote_assignment_active_fence_test_support.rs"]
mod test_support;
#[cfg(test)]
pub(in crate::daemon::db::task_board) use test_support::{
    task_board_execution_generation_has_active_remote_assignment,
    task_board_execution_has_active_remote_assignment,
};
