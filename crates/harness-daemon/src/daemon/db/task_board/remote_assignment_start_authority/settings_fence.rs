...
pub(in super::super) async fn authorize_task_board_remote_executor_provisioning(
    db: &AsyncDaemonDb,
...
pub(in super::super) async fn revoke_task_board_remote_executor_start_after_cleanup(
    db: &AsyncDaemonDb,
    authority: &TaskBoardRemoteExecutorStartAuthority,
    observed_at: &str,
...
pub(in super::super) async fn abandon_task_board_remote_executor_start_after_restart(
    db: &AsyncDaemonDb,
    authority: &TaskBoardRemoteExecutorStartAuthority,
...
pub(in super::super) async fn abandon_task_board_remote_executor_claim_after_restart(
    db: &AsyncDaemonDb,
    assignment_id: &str,
    identity: &TaskBoardRemoteExecutorIdentity,
    successor_instance_id: &str,
