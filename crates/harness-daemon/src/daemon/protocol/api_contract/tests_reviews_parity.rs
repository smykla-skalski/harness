...
fn review_routes_ws_parity_part_1() -> Vec<(HttpRouteMethod, &'static str, &'static str, bool)> {
    vec![
        (
...
fn review_routes_ws_parity_part_2() -> Vec<(HttpRouteMethod, &'static str, &'static str, bool)> {
    vec![
        (
            HttpRouteMethod::Post,
...
fn review_routes_ws_parity_part_3() -> Vec<(HttpRouteMethod, &'static str, &'static str, bool)> {
    vec![
        (
            HttpRouteMethod::Post,
...
fn expected_review_routes_ws_parity() -> Vec<(HttpRouteMethod, &'static str, &'static str, bool)> {
    let mut expected = Vec::new();
    expected.extend(review_routes_ws_parity_part_1());
    expected.extend(review_routes_ws_parity_part_2());
    expected.extend(review_routes_ws_parity_part_3());
    expected
}
...
fn review_routes_have_complete_ws_parity() {
    ...
    let actual: Vec<_> = review_routes
        ...
        .collect();
    assert_eq!(actual, expected_review_routes_ws_parity());
}
