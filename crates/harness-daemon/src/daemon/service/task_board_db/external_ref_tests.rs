...
async fn external_ref_creation_rejects_client_sync_state() {
    ...
    let request = TaskBoardCreateItemRequest {
        ...
        body: "Body".into(),
        status: None,
        priority: crate::task_board::types::TaskBoardPriority::default(),
        agent_mode: crate::task_board::types::AgentMode::default(),
        workflow_kind: crate::task_board::item_intent::TaskBoardWorkflowKind::default(),
        kind: crate::task_board::types::TaskBoardItemKind::default(),
