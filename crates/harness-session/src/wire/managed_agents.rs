...
use crate::types::{HarnessSessionId, ManagedAgentId, SessionAgentId};
...
#[cfg(test)]
mod tests {
    use crate::types::{AgentStatus, HarnessSessionId, ManagedAgentId, SessionAgentId};
    ...
    #[expect(
        ...
        reason = "one linear scenario asserting all three snapshot variants, not nested branching logic"
    )]
