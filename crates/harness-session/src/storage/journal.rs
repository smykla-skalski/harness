...
pub fn load_log_entries(layout: &SessionLayout) -> Result<Vec<SessionLogEntry>, CliError> {
...
/// # Errors
/// Returns `CliError` on parse or I/O failure.
pub fn load_reviews(layout: &SessionLayout, task_id: &str) -> Result<Vec<Review>, CliError> {
