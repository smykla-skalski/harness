...
#[must_use]
pub fn log_session_started(title: &str, context: &str) -> SessionTransition {
...
#[must_use]
pub fn log_session_ended() -> SessionTransition {
    SessionTransition::SessionEnded
}

#[must_use]
pub fn log_session_archived() -> SessionTransition {
    SessionTransition::SessionArchived
}

#[must_use]
pub fn log_session_adopted(session_id: &str) -> SessionTransition {
...
#[must_use]
pub fn log_agent_removed(agent_id: &str) -> SessionTransition {
...
#[must_use]
pub fn log_agent_disconnected(agent_id: &str, reason: &str) -> SessionTransition {
...
pub fn log_task_created(spec: &TaskSpec<'_>, item: &WorkItem) -> SessionTransition {
...
#[must_use]
pub fn log_task_assigned(task_id: &str, agent_id: &str) -> SessionTransition {
...
#[must_use]
pub fn log_task_queued(task_id: &str, agent_id: &str) -> SessionTransition {
...
#[must_use]
pub fn log_checkpoint_recorded(
    task_id: &str,
    checkpoint_id: &str,
    progress: u8,
) -> SessionTransition {
...
#[must_use]
pub fn log_signal_sent(signal_id: &str, agent_id: &str, command: &str) -> SessionTransition {
...
#[must_use]
pub fn log_signal_acknowledged(
    signal_id: &str,
    agent_id: &str,
    result: AckResult,
) -> SessionTransition {
...
/// # Errors
/// Returns [`CliError`] when the session layout cannot be resolved or a log
/// entry cannot be appended.
pub fn append_leave_signal_logs(
    project_dir: &Path,
    session_id: &str,
    actor_id: &str,
...
/// Returns [`CliError`] when the session layout cannot be resolved or a log
/// entry cannot be appended.
pub fn append_task_drop_effect_logs(
    project_dir: &Path,
    session_id: &str,
    actor_id: &str,
...
#[must_use]
pub fn started_task_signals(effects: &[TaskDropEffect]) -> Vec<TaskStartSignalRecord> {
    effects
        .iter()
