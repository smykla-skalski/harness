...
// `daemon_path_validation` and `daemon_reentrancy` used to live here; they
// needed the root crate's fake-daemon fixture, so they moved to
// `tests/integration/session_service_daemon_{path_validation,reentrancy}.rs`
// rather than pulling that fixture in as a real dependency of this crate.
mod basics;
mod leave_signals;
mod liveness;
