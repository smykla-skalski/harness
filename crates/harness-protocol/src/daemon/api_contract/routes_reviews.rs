...
pub(crate) const ROUTES: &[HttpApiRouteContract] = &[
    ...
    HttpApiRouteContract {
        method: HttpRouteMethod::Post,
        path: http_paths::REVIEWS_PULL_REQUEST_RESOLVE,
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_PULL_REQUEST_RESOLVE,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
    ...
    HttpApiRouteContract {
        method: HttpRouteMethod::Post,
        path: http_paths::REVIEWS_POLICY_PREVIEW,
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_POLICY_PREVIEW,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
        method: HttpRouteMethod::Post,
        path: http_paths::REVIEWS_POLICY_START,
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_POLICY_START,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
        method: HttpRouteMethod::Post,
        path: http_paths::REVIEWS_POLICY_STATUS,
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_POLICY_STATUS,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
    ...
    HttpApiRouteContract {
        ...
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_REQUEST_REVIEW,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
    ...
    HttpApiRouteContract {
        ...
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_FILES_COMMENT,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
    ...
    HttpApiRouteContract {
        method: HttpRouteMethod::Post,
        path: http_paths::REVIEWS_FILES_PREVIEW,
        parity: HttpRouteParity::Rpc {
            ws_method: ws_methods::REVIEWS_FILES_PREVIEW,
        },
        swift_client_exposed: true,
    },
    HttpApiRouteContract {
