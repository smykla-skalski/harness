...
pub const TASK_BOARD_TRIAGE_ESCALATION_VERDICT: &str =
    "/v1/task-board/triage/escalations/{escalation_id}/verdict";
...
pub const TASK_BOARD_SYNC_CANCEL: &str = "/v1/task-board/sync/cancel";
pub const TASK_BOARD_SYNC_STATUS: &str = "/v1/task-board/sync/status";
...
pub const TASK_BOARD_WORKING_COPIES: &str = "/v1/task-board/working-copies";
pub const TASK_BOARD_WORKING_COPIES_OBTAIN: &str = "/v1/task-board/working-copies/obtain";
pub const TASK_BOARD_WORKING_COPIES_DELETE: &str = "/v1/task-board/working-copies/delete";
...
pub const POLICY_APPROVAL_GRANT_REVOKE: &str = "/v1/policy-approval-grants/revoke";
...
pub const POLICIES_DUMP: &str = "/v1/policies/dump";
pub const POLICIES_IMPORT: &str = "/v1/policies/import";
