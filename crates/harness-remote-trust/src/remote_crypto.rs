...
#[must_use]
pub fn sha256_storage_value(value: &str) -> String {
    format!(
...
#[must_use]
pub fn parse_sha256_storage_digest(value: &str) -> Option<[u8; 32]> {
...
#[must_use]
pub fn verify_sha256_storage_value(storage_value: &str, candidate_value: &str) -> bool {
