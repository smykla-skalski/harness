...
#[must_use]
pub fn bounded_remote_request_id(request_id: &str) -> String {
...
#[must_use]
pub fn remote_token_hint(token: &str) -> String {
...
#[must_use]
pub fn redact_remote_error_detail(detail: &str) -> String {
