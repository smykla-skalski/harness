...
/// # Errors
/// Returns `TimelineError` when the GraphQL call fails or the response
/// cannot be mapped into timeline entries.
pub async fn fetch_timeline_page<C: TimelineClient>(
