...
use crate::acp::client::ClientCallCancel;

#[derive(Clone, Copy)]
pub(in crate::acp::client) struct TerminalWaitSnapshot {
    pub(super) generation: u64,
    pub(super) reader_closed: bool,
}

pub(in crate::acp::client) enum TerminalLifecycleWait {
    TimedOut,
    Cancelled,
...
pub(in crate::acp::client) struct TerminalWaitSignal {
