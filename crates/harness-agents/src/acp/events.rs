...
use crate::runtime::event::{ConversationEvent, ConversationEventKind};
...
mod tests {
    use super::*;
    use agent_client_protocol::schema::v1::{
        AvailableCommandsUpdate, ConfigOptionUpdate, ContentChunk, Cost, CurrentModeUpdate,
        MessageId, SessionId, SessionModeId, SessionNotification, TextContent, ToolCall,
        ToolCallId, ToolCallUpdate, ToolCallUpdateFields, ToolKind, UsageUpdate,
    };

    use crate::acp::ring::RawSessionUpdate;
