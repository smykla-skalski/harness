...
pub struct DurableCreateResult {
    pub linked_item: Option<TaskBoardItem>,
    pub durable_create: bool,
}

pub async fn recover_scope_intents(
...
pub async fn create_item_durably(
    board: &dyn TaskBoardSyncStore,
    client: &dyn ExternalSyncClient,
    attempt: &ExternalProviderScopeAttempt,
    item: &TaskBoardItem,
...
pub async fn suppress_known_create_markers(
    board: &dyn TaskBoardSyncStore,
    client: &dyn ExternalSyncClient,
