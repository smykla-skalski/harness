...
pub const MAX_REMOTE_RECEIPT_JSON_BYTES: usize = 16 * 1024;
pub const MAX_REMOTE_LIFECYCLE_JSON_BYTES: usize = 4 * 1024 * 1024;
pub const MAX_REMOTE_OFFER_JSON_BYTES: usize = 16 * 1024 * 1024;
pub const MAX_REMOTE_SOURCE_RECOVERY_RESPONSE_JSON_BYTES: usize = 2 * MAX_REMOTE_RECEIPT_JSON_BYTES;
...
pub const MAX_REMOTE_SOURCE_BUNDLE_JSON_BYTES: usize = SOURCE_BUNDLE_PREFIX.len()
...
pub const MAX_REMOTE_SOURCE_ABANDON_JSON_BYTES: usize = SOURCE_ABANDON_PREFIX.len()
    + MAX_REMOTE_OFFER_JSON_BYTES
