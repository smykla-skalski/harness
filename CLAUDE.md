...
- `.claude/rules/swiftui-selection-identity.md` - Picker/tag selection validity, dynamic option clamping, session-bound state reset, inspector actor fallback order
...
| [swiftui-selection-identity.md](.claude/rules/swiftui-selection-identity.md) | `apps/harness-monitor-macos/Sources/**` | Picker/tag validity, dynamic selection clamping, session-bound state reset |
