...
| `act4` | `task_review` and `task_autospawn` both assigned and started. | `task_review_id`, `task_autospawn_id` | `task_review` selected in inspector. `taskInspectorCard.value == task_review_id`. `task_autospawn` reflects in-progress. |
